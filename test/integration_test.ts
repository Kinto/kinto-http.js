...
interface TitleRecord extends KintoRecord {
  title: string;
}
...
describe("Integration tests", function() {
      ...
      describe("Default options", () => {
        describe("Autogenerated id", () => {
          beforeEach(() => {
            return api
              .createBucket(null)
              .then(res => (result = res as KintoEntity));
          });
    ...
    describe("#deleteBucket()", () => {
      ...
      beforeEach(() => {
        return api
          .createBucket("foo")
          .then(
            res => (last_modified = (res as KintoEntity).data.last_modified)
          );
      });
  ...
  describe("Chainable API", () => {
    ...
    describe(".bucket()", () => {
      ...
      describe(".getData()", () => {
        let result: KintoRecord;

        beforeEach(() => {
          return bucket.getData<KintoRecord>().then(res => (result = res));
        });
      ...
      describe(".setData()", () => {
        ...
        it("should post data to the bucket", () => {
          return bucket.setData({ a: 1 }).then(res => {
            expect((res as KintoEntity).data.a).eql(1);
            expect((res as KintoEntity).permissions.read).to.include(
              "github:jon"
            );
          });
        });
        ...
        it("should patch existing data for the bucket", () => {
          return bucket
            ...
            .then(res => {
              expect((res as KintoEntity).data.a).eql(1);
              expect((res as KintoEntity).data.b).eql(2);
              expect((res as KintoEntity).permissions.read).to.include(
                "github:jon"
              );
            });
        ...
        it("should post data to the default bucket", () => {
          return api
            .bucket("default")
            .setData({ a: 1 })
            .then(res => (res as KintoEntity).data)
      ...
      describe(".setPermissions()", () => {
        ...
        it("should set bucket permissions", () => {
          return bucket.setPermissions({ read: ["github:n1k0"] }).then(res => {
            expect((res as KintoEntity).data.a).eql(1);
            expect((res as KintoEntity).permissions.read).eql(["github:n1k0"]);
          });
        });
      ...
      describe(".addPermissions()", () => {
        ...
        it("should append bucket permissions", () => {
          return bucket
            ...
            .then(res => {
              expect((res as KintoEntity).data.a).eql(1);
              expect((res as KintoEntity).permissions.read!.sort()).eql([
                "accounts:gabi",
                "github:n1k0",
              ]);
            });
      ...
      describe(".removePermissions()", () => {
        ...
        it("should pop bucket permissions", () => {
          return bucket
            ...
            .then(res => {
              expect((res as KintoEntity).data.a).eql(1);
              expect((res as KintoEntity).permissions.read).eql(undefined);
            });
        });
      });
      ...
      describe(".createCollection()", () => {
        ...
        it("should create an automatically named collection", () => {
          ...
          return bucket
            .createCollection()
            .then(res => (generated = (res as KintoEntity).data.id))
            .then(_ => bucket.listCollections())
            .then(({ data }) =>
            ...
            return bucket
              ...
              .then(res =>
                bucket.deleteCollection("posts", {
                  safe: true,
                  last_modified: (res as KintoEntity).data.last_modified - 1000,
                })
              )
              .should.be.rejectedWith(Error, /412 Precondition Failed/);
          });
      ...
      describe(".createGroup()", () => {
        ...
        it("should create an automatically named group", () => {
          ...
          return bucket
            .createGroup()
            .then(res => (generated = (res as KintoEntity<Group>).data.id))
            .then(_ => bucket.listGroups())
            .then(({ data }) =>
              expect(data.some(x => x.id === generated)).eql(true)
            );
        ...
        describe("Permissions option", () => {
          ...
          beforeEach(() => {
            return bucket
              ...
              .then(res => (result = res as KintoEntity<Group>));
          });
      ...
      describe(".getGroup()", () => {
        it("should get a group", () => {
          return bucket
            ...
            .then(res => {
              expect((res as KintoEntity<Group>).data.id).eql("foo");
              expect((res as KintoEntity<Group>).data.members).eql([]);
              expect(
                (res as KintoEntity<Group>).permissions.write
              ).to.have.lengthOf(1);
            });
        });
      });
      ...
      describe(".updateGroup()", () => {
        ...
        it("should patch a group", () => {
          return bucket
            ...
            .then(res =>
              bucket.updateGroup(
                { id: (res as KintoEntity<Group>).data.id, blah: 43 },
                { patch: true }
              )
            )
            .then(_ => bucket.listGroups())
          ...
          it("should perform concurrency checks with last_modified", () => {
            return bucket
              ...
              .then(res =>
                bucket.updateGroup(
                  {
                    id: (res as KintoEntity<Group>).data.id,
                    members: ["github:me"],
                    title: "foo",
                    last_modified: 1,
                  },
            ...
            return bucket
              ...
              .then(res =>
                bucket.deleteGroup("posts", {
                  safe: true,
                  last_modified:
                    (res as KintoEntity<Group>).data.last_modified - 1000,
                })
              )
              .should.be.rejectedWith(Error, /412 Precondition Failed/);
          });
        ...
        describe(label, () => {
          ...
          describe(".setPermissions()", () => {
            ...
            it("should set typed permissions", () => {
              return coll
                ...
                .then(res => {
                  expect((res as KintoEntity).data.a).eql(1);
                  expect((res as KintoEntity).permissions.read).eql([
                    "github:n1k0",
                  ]);
                });
            });
          ...
          describe(".setData()", () => {
            ...
            it("should set collection data", () => {
              return coll.setData({ signed: true }).then(res => {
                expect((res as KintoEntity).data.signed).eql(true);
                expect((res as KintoEntity).permissions.read).to.include(
                  "github:n1k0"
                );
              });
          ...
          describe(".updateRecord()", () => {
            ...
            it("should patch a record", () => {
              return coll
                ...
                .then(res =>
                  coll.updateRecord(
                    { id: (res as KintoEntity).data.id, blah: 43 },
                    { patch: true }
                  )
                )
                .then(_ => coll.listRecords())
            ...
            it("should create the record if it doesn't exist yet", () => {
              ...
              return coll
                ...
                .then(res => coll.getRecord((res as KintoEntity).data.id))
                .should.eventually.have.property("data")
                .to.have.property("title")
                .eql("blah");
            });
          ...
          describe(".deleteRecord()", () => {
            it("should delete a record", () => {
              return coll
                .createRecord({ title: "foo" })
                .then(res => coll.deleteRecord((res as KintoEntity).data.id))
                .then(_ => coll.listRecords())
                .should.eventually.have.property("data")
                .eql([]);
            });
            ...
            describe("Safe option", () => {
              it("should perform concurrency checks", () => {
                return coll
                  .createRecord({ title: "foo" })
                  .then(res =>
                    coll.deleteRecord((res as KintoEntity).data.id, {
                      last_modified: 1,
                      safe: true,
                    })
                  )
          ...
          describe(".addAttachment()", () => {
            describe("With filename", () => {
              ...
              let result: KintoEntity<{ attachment: Attachment }>;
              ...
              beforeEach(() => {
                return coll
                  ...
                  .then(
                    res =>
                      (result = res as KintoEntity<{ attachment: Attachment }>)
                  );
              });
          ...
          describe(".listRecords()", () => {
            ...
            describe("'at' retrieves a snapshot at a given timestamp", () => {
              let rec1: KintoRecord, rec2: KintoRecord, rec3: KintoRecord;

              beforeEach(() => {
                return coll
                  .createRecord({ n: 1 })
                  .then(resp => {
                    rec1 = (resp as KintoEntity).data;
                    return coll.createRecord({ n: 2 });
                  })
                  .then(res => {
                    rec2 = (res as KintoEntity).data;
                    return coll.createRecord({ n: 3 });
                  })
                  .then(res => (rec3 = (res as KintoEntity).data));
              });
              ...
              it("should handle updates", () => {
                let updatedRec2: KintoRecord;
                return coll
                  .updateRecord({ ...rec2, n: 42 })
                  .then(res => {
                    updatedRec2 = (res as KintoEntity).data;
                ...
                return coll
                  ...
                  .then(res => {
                    return coll.listRecords({
                      at: (res as KintoEntity).data.last_modified,
                    });
                  })
                  .then(({ data }) => {
              ...
              describe("Mixed CRUD operations", () => {
                let rec4: KintoRecord;
                let s1: KintoRecord[] = [],
                  s2: KintoRecord[] = [],
                  s3: KintoRecord[] = [],
                  s4: KintoRecord[] = [];
                let rec1up: KintoRecord;
